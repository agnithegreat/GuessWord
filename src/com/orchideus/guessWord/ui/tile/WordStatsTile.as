...
public class WordStatsTile extends AbstractView {
    ...
    public function WordStatsTile(assets:AssetManager, deviceType:DeviceType) {
    ...
    override protected function initialize():void {
        ...
        _icon = new Image(_assets.getTexture("main_enemy_ico_off"));
    ...
    override protected function initializeIPhone():void {
        ...
        _text1 = createTextField(_back.width-32, 10, 16, "СОРЕВНУЙСЯ");
        _text1.nativeFilters = [new GlowFilter(0x666666, 1, 2, 2, 3, 3)];
        _text1.autoScale = true;
        _text1.x = 32;
        _text1.y = 4;

        _text2 = createTextField(_back.width-32, 10, 16, "СО СВОИМИ");
        _text2.nativeFilters = [new GlowFilter(0x666666, 1, 2, 2, 3, 3)];
        _text2.autoScale = true;
        _text2.x = 32;
        _text2.y = 4 + _text1.textBounds.height;

        _text3 = createTextField(_back.width-32, 10, 16, "ДРУЗЬЯМИ");
        _text3.nativeFilters = [new GlowFilter(0x666666, 1, 2, 2, 3, 3)];
        _text3.x = 32;
    ...
    public function enable():void {
        _back.upState = _assets.getTexture("main_enemy_btn_up");
        _back.downState = _assets.getTexture("main_enemy_btn_down");

        _icon.texture = _assets.getTexture("main_enemy_ico_on");
    }
