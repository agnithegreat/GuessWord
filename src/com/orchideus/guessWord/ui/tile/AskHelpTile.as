...
public class AskHelpTile extends AbstractView {
    ...
    public function AskHelpTile(assets:AssetManager, deviceType:DeviceType) {
        super(assets, deviceType);
    }

    override protected function initialize():void {
        _back = new Button(_assets.getTexture("main_askhelp_btn_off"));
        addChild(_back);

        _icon = new Image(_assets.getTexture("main_askhelp_ico_off"));
    ...
    override protected function initializeIPhone():void {
        ...
        _text1 = createTextField(_back.width-8, 8, 16, "ПОПРОСИТЬ");
        _text1.nativeFilters = [new GlowFilter(0x666666, 1, 2, 2, 3, 3)];
        _text1.autoScale = true;
        _text1.x = 4;
        _text1.y = 32;

        _text2 = createTextField(_back.width-8, 8, 16, "ПОМОЩИ");
        _text2.nativeFilters = [new GlowFilter(0x666666, 1, 2, 2, 3, 3)];
        _text2.autoScale = true;
        _text2.x = 4;
        _text2.y = 32 + _text1.textBounds.height;

        _text3 = createTextField(_back.width-8, 8, 16, "У ДРУЗЕЙ");
        _text3.nativeFilters = [new GlowFilter(0x666666, 1, 2, 2, 3, 3)];
        _text3.x = 4;
    ...
    public function enable():void {
        _back.upState = _assets.getTexture("main_askhelp_btn_up");
        _back.downState = _assets.getTexture("main_askhelp_btn_down");

        _icon.texture = _assets.getTexture("main_askhelp_ico_on");
    }

    private function handleClick(event: Event):void {
        dispatchEventWith(Sound.SOUND, true, Sound.CLICK);
        dispatchEventWith(Social.ASK, true);
    }
}
}
