...
public class AskHelpTile extends AbstractView {
    ...
    override protected function initialize():void {
        ...
        _text = _refs.locale.getString("main.tile.ask").split("\n");
    ...
    override protected function initializeIPhone():void {
        ...
        _text3 = createTextField(_back.width-16, 16, 32, _text[2]);
        _text3.x = 8;
        _text3.y = 64 + _text1.textBounds.height + _text2.textBounds.height;
    }
    ...
    public function enable():void {
        ...
        _icon.texture = _refs.assets.getTexture("main_askhelp_ico_on");
    }
